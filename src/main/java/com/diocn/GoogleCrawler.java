...
public class GoogleCrawler  extends BreadthCrawler {
     ...
     */
    public GoogleCrawler(String crawlPath, boolean autoParse) {
        super(crawlPath, autoParse);
        /*种子页面*/
        this.addSeed("https://play.google.com/store/apps/category/GAME");

        /*正则规则设置*/
        /*爬取符合 http://news.hfut.edu.cn/show-xxxxxxhtml的URL*/
//        this.addRegex("http://news.hfut.edu.cn/show-.*html");
        this.addRegex("https://play.google.com/*");
...
//            		
//        }
        if (page.matchUrl("https://play.google.com/store/apps/details?id=com.*")) {
        	packageName = page.getUrl().replace("https://play.google.com/store/apps/details?id=", "");
        	System.out.println(packageName+"搜索到了");
